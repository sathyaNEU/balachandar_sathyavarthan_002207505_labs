...
public class LoginScreen extends javax.swing.JPanel {
    ...
    AdminWorkAreaJPanel amdinAdminWorkAreaJPanel;
    SupplierWorkAreaJPanel supplierWorkAreaJPanel;
    GlobalFeatureList globalFeatureList;
    /**
     * Creates new form LoginScreen
     */
    public LoginScreen(JPanel mainWorkArea, SupplierDirectory supplierDirectory, GlobalFeatureList globalFeatureList) {
        initComponents();
        
        this.mainWorkArea = mainWorkArea;
        this.supplierDirectory = supplierDirectory;
        this.globalFeatureList = globalFeatureList;
        this.amdinAdminWorkAreaJPanel = new AdminWorkAreaJPanel(mainWorkArea, supplierDirectory);
        this.supplierWorkAreaJPanel = new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier, supplierDirectory, globalFeatureList);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(this.cmbRoles.getSelectedItem().getClass()==AdminWorkAreaJPanel.class){
            this.amdinAdminWorkAreaJPanel = new AdminWorkAreaJPanel(mainWorkArea, supplierDirectory);
            mainWorkArea.add("amdinAdminWorkAreaJPanel",amdinAdminWorkAreaJPanel);
            ...
            if(cmbSuppliers.getSelectedItem()==null){
                ...
                String supl = this.cmbSuppliers.getSelectedItem().toString();
                System.out.println(supl);
                this.selectedSupplier = this.supplierDirectory.searchSupplier(supl);
                this.supplierWorkAreaJPanel = new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier, supplierDirectory, globalFeatureList);
                mainWorkArea.add("supplierWorkAreaJPanel",supplierWorkAreaJPanel);
                ((CardLayout)mainWorkArea.getLayout()).next(mainWorkArea);
            }
        }
    ...
    private void populateRoleCombo() {
        ...
        this.cmbRoles.addItem(amdinAdminWorkAreaJPanel);
        this.cmbRoles.addItem(supplierWorkAreaJPanel);
