...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void btnManageSuppliersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageSuppliersActionPerformed
        ...
        this.workArea.add("manageSuppliers",manageSuppliers);
        ((CardLayout)this.workArea.getLayout()).next(this.workArea);
        
     
    }//GEN-LAST:event_btnManageSuppliersActionPerformed

    private void btnLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogOutActionPerformed
        Component comp = mainWorkArea.getComponent(mainWorkArea.getComponentCount()-2);        // TODO add your handling code here:
        LoginScreen loginScreen = (LoginScreen)comp;
        loginScreen.populateSupplierCombo();
        mainWorkArea.remove(this);
       ((CardLayout)mainWorkArea.getLayout()).previous(mainWorkArea);
