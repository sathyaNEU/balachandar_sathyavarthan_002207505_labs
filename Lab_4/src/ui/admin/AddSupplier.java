...
public class AddSupplier extends javax.swing.JPanel {
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        if(supl.isBlank() || desc.isBlank())
             JOptionPane.showMessageDialog(this, "Supplier fields cannot be empty", "ERROR", JOptionPane.ERROR_MESSAGE);
        else{
        if(this.supplierDirectory.searchSupplier(supl)==null)
        {
            Supplier supplier = supplierDirectory.addSupplier();
        supplier.setSupplyName(txtName.getText());
        supplier.setDesc(desc);
        ...
        JOptionPane.showMessageDialog(this, "Supplier successfully added", "Warning", JOptionPane.INFORMATION_MESSAGE);
                backAction();
                     ...
                     JOptionPane.showMessageDialog(this, "Supplier profile already exist with the same name", "ERROR", JOptionPane.ERROR_MESSAGE);
