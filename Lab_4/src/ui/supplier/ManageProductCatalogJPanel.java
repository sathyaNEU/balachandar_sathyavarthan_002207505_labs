...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageProductCatalogJPanel(JPanel workArea, Supplier supplier,GlobalFeatureList globalFeatureList) {
        initComponents();
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if(index==-1)
            JOptionPane.showMessageDialog(this, "Product Not selected","ERROR", JOptionPane.ERROR_MESSAGE);
        else{
            int id = (int)tblProducts.getValueAt(index, 1);
            Product product = this.supplier.getProductCatalog().searchProduct(id);
            ViewProductDetailJPanel viewProductDetailJPanel = new ViewProductDetailJPanel(workArea, product, globalFeatureList);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(index==-1)
            ...
            int id = (int)tblProducts.getValueAt(index, 1);
            Product product = this.supplier.getProductCatalog().searchProduct(id);
            this.supplier.getProductCatalog().removeProduct(product); 
            refreshTable();
        }
